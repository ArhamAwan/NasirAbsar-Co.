        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className={`text-xl font-bold ${isScrolled ? 'text-gray-900' : 'text-white'}`} style={{ fontDisplay: 'swap' }}>
                Nasir Absar & Co.
              </h1>
              <p className={`text-sm ${isScrolled ? 'text-gray-600' : 'text-blue-100'}`} style={{ fontDisplay: 'swap' }}>
